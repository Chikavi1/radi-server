...
@section('content')
	<h1 class="center-align">Desparasitaciones</h1>
			 <div class="row">
		...
		<form id="fomulario" action="{{ route('desparasitacion.store') }}" method="POST" style="display: none;" >
			{{ @csrf_field() }}
	        ...
	        <div class="input-field col s12 offset-m2 m8">
		            <input type="text" class="datepicker" name="created_at" placeholder="Ingrese Fecha" required>
		       </div>
